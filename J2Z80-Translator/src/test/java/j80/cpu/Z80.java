 ...
 * index instruction.
 */
public abstract class Z80 implements Z80debug {
...
// flag tables
    ...
    private final void adcHL(int value) {
        int _HLD = HL();
        int result = (int)(short)_HLD + (int)(short)value + ( F & 1 );
    ...
    public int peekb(int add) {
        return getByteFromMemory(add & 0xFFFF) & 0xFF;
    }

    public void pokeb(int add, int value) {
        setByteToMemory(add & 0xFFFF, value & 0xFF);
    }

    public abstract int getByteFromMemory(int address);
    public abstract void setByteToMemory(int address, int value);
    ...
    private void error(int instruction, int address) {
        final String text = "CPU error: illegal instruction $" + Integer.toHexString(instruction) + " at $" + Integer.toHexString(address);
