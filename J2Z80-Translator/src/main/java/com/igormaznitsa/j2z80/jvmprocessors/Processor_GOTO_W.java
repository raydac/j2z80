...
// class to process GOTO_W with code 200
public class Processor_GOTO_W extends AbstractJvmCommandProcessor {
    private final String template; 
    
    public Processor_GOTO_W(){
        super();
        template = loadResourceFileAsString("GOTO_W.a80");
    }
    ...
    public void process(final MethodTranslator methodTranslator, final Instruction instruction, final InstructionHandle handle, final Writer out) throws IOException {
        final GOTO_W gotow = (GOTO_W)instruction;
