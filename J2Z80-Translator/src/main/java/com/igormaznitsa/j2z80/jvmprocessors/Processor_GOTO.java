...
// class to process GOTO with code 167
public class Processor_GOTO extends AbstractJvmCommandProcessor {
    private final String template; 
    
    public Processor_GOTO(){
        super();
        template = loadResourceFileAsString("GOTO.a80");
    }
    ...
    public void process(final MethodTranslator methodTranslator, final Instruction instruction, final InstructionHandle handle, final Writer out) throws IOException {
        final GOTO gotoins = (GOTO)instruction;
