...
public class AsmCommandRLC extends AbstractAsmCommand {

  public AsmCommandRLC() {
    super();
    addCase("A", (byte) 0xCB, (byte) 0x07);
    addCase("B", (byte) 0xCB, (byte) 0x00);
    addCase("C", (byte) 0xCB, (byte) 0x01);
    addCase("D", (byte) 0xCB, (byte) 0x02);
    addCase("E", (byte) 0xCB, (byte) 0x03);
    addCase("H", (byte) 0xCB, (byte) 0x04);
    addCase("L", (byte) 0xCB, (byte) 0x05);
    addCase("(HL)", (byte) 0xCB, (byte) 0x06);
  }
  ...
  public byte[] makeMachineCode(final AsmTranslator context, final ParsedAsmLine asm) {
    ...
    if (isIndexRegisterReference(arg)) {
      ...
      return new byte[] {prefix, (byte) 0xCB, (byte) offset, (byte) 0x06};
    } else {
